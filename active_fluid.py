...
class active_fluid:     # OOP
    ...
    def set_zero(self):              # initializing simulation configurations
        ...
        self.X = np.random.uniform(-self.L/2, self.L/2,self.N_passive)
        self.Y = np.random.uniform(-self.L/2, self.L/2,self.N_passive)     
    ...
    def animate(self,N_iter, record=False):
